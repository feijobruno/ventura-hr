...
router.get("/users/:page", validateToken, async (req, res) => {
...
router.put("/user-senha", validateToken, async (req, res) => {
...
router.put('/edit-user-image/:id', validateToken, upload.single('image'), async (req, res) => {
    if(req.file){
        const { id } = req.params;
