...
router.get("/view-profile", validateToken, async (req, res) => {
    const id = req.userId;
...
router.put("/edit-profile-password", validateToken, async (req, res) => {
    const id = req.userId;
...
router.put('/edit-profile-image', validateToken, upload.single('image'), async (req, res) => {
    if(req.file){
