                                    ...
                                    <form onSubmit={addJobSkill}>
                                        <div className="form-row align-items-center">
                                            <div className="form-group col-md-4">
                                                ...
                                                <input type="text" className="form-control" name="skill" id="skill" placeholder="Nome" onChange={valueInput} />
                                            </div>
                                            <div className="form-group col-md-4">
                                                <label for="description">Descrição</label>
                                                <input type="text" className="form-control" name="description" id="description" placeholder="Descrição" onChange={valueInput} />
                                            </div>
                                        ...
                                        <button type="submit" className="btn btn-primary mt-4">Inserir</button>
                                    </form>
                                </div>
                            </div>
