                                ...
                                <div className="card-body">
                                    <div className="row">
                                        <div className="col-md-6">
                                            <strong>Mensagens do Sistema:</strong><br />Lembre-se que é possível recomendar uma vaga aos seus amigos - basta informar os seus emais
                                        </div>
                                        <div className="col-md-6">
                                        <strong>Suas Vagas Respondidas:</strong>
