...
export const AddJob = () => {
    ...
    const addJob = async e => {
        ...
        await api.post('/job/job', job, headers)
            .then((response) => {
                setStatus({
                    type: 'success',
                ...
                <div className="wrapper">
                    <div className="row">
                        ...
                        <div className="alert-content-adm">
                            ...
                            {status.type === 'success' ?
                                <Redirect to={{
                                    pathname: '/add-skill/' + status.id_job,
                                    state: {
                                        type: "success",
                            ...
                            <form onSubmit={addJob} className="form-adm">
                                ...
                                <div className="row-input">
                                    <div className="column">
                                        ...
                                        <input type="text" name="title" id="title" className="input-adm" placeholder="Cargo" onChange={valueInput} />
                                    </div>
                                    
                                <div className="column">
                                    <label className="title-input">Descrição</label>
                                    <input type="text" name="description" id="description" className="input-adm" placeholder="Descrição" onChange={valueInput} />
                                </div>
                                <div className="column">
                                    <label className="title-input">Empresa</label>
                                    <input type="text" name="company" id="company" className="input-adm" placeholder="Empresa" onChange={valueInput} />
                                </div>
                                </div>
                                <div className="row-input">
                                <div className="column">
                                        <label className="title-input">Cidade</label>
                                        <input type="text" name="city" id="city" className="input-adm" placeholder="Cidade" onChange={valueInput} />
                                </div>
                                ...
                                <div className="column">
                                 ...
                                 <div className="column">
                                    ...
                                    <select name="hiring_type" className="input-select" onChange={valueInput}>
